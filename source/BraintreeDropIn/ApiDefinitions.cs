...
namespace BraintreeDropIn
{
	...
	interface BTDropInController : IUIToolbarDelegate, IUIViewControllerTransitioningDelegate
	{
		...
		// @property (readonly, nonatomic, strong) int * _Nonnull apiClient;
		[Export ("apiClient", ArgumentSemantic.Strong)]
		unsafe int* ApiClient { get; }

		// @property (readonly, nonatomic, strong) int * _Nonnull dropInRequest;
		[Export ("dropInRequest", ArgumentSemantic.Strong)]
		unsafe int* DropInRequest { get; }
	...
	// typedef void (^BTDropInControllerHandler)(BTDropInController * _Nonnull, int * _Nullable, NSError * _Nullable);
	unsafe delegate void BTDropInControllerHandler (BTDropInController arg0, [NullAllowed] int* arg1, [NullAllowed] NSError arg2);
	...
	{
		// @property (nonatomic, strong) int * _Nullable payPalRequest;
		[NullAllowed, Export ("payPalRequest", ArgumentSemantic.Strong)]
		unsafe int* PayPalRequest { get; set; }

		// @property (nonatomic, strong) int * _Nullable venmoRequest;
		[NullAllowed, Export ("venmoRequest", ArgumentSemantic.Strong)]
		unsafe int* VenmoRequest { get; set; }
		...
		// @property (nonatomic, strong) int * _Nullable threeDSecureRequest;
		[NullAllowed, Export ("threeDSecureRequest", ArgumentSemantic.Strong)]
		unsafe int* ThreeDSecureRequest { get; set; }
		...
		// @property (nonatomic, strong) int * _Nullable uiCustomization;
		[NullAllowed, Export ("uiCustomization", ArgumentSemantic.Strong)]
		unsafe int* UiCustomization { get; set; }
	}
	...
	{
		// extern NSString *const _Nonnull BTDropInErrorDomain;
		[Field ("BTDropInErrorDomain", "__Internal")]
		NSString BTDropInErrorDomain { get; }
	}
